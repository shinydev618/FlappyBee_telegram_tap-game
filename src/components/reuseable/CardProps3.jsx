...
const CardProps3 = ({ style, title, img2, img1, value }) => {
  return (
    <div className="flex w-full flex-col py-2 bg-black z-[5000] px-3 items-center justify-center gap-1 rounded-md shadow-sm border-[#1ED760] border-[1px] shadow-[#1ED760]">
